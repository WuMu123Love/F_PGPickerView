...
//        cell.label.attributedText = [[NSAttributedString alloc] initWithString: @""];
        cell.attributedText = [[NSAttributedString alloc] initWithString: @""];
        cell.contentView.backgroundColor = [UIColor clearColor];
    }else {
//        cell.label.attributedText = self.datas[row];
        cell.attributedText = self.datas[row];
    ...
    if (tableView == self.centerTableView) {
        cell.textColor = self.textColorOfSelectedRow;
        cell.font = self.textFontOfSelectedRow;
//        cell.label.textColor = self.textColorOfSelectedRow;
//        cell.label.font = self.textFontOfSelectedRow;
    }else {
        cell.textColor = [self textColorOfOtherRow:row];
        cell.font = [self textFontOfOtherRow:row];
